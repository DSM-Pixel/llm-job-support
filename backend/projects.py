...
프로젝트 열람 범위(visibility):
  - team   : 같은 팀(같은 company_id + team) 전원 + 그 팀의 검수자 + 회사 대표 + 슈퍼
  - private: 만든 본인 + 그 팀의 검수자 + 회사 대표 + 슈퍼
